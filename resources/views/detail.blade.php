      ...
      <div class="col-lg-10 col-md-12 col-lg-offset-1">
        <div class="ps-product__thumbnail">
          <div class="ps-product__preview">
            <div class="ps-product__variants">
              ...
              <div class="item"><img src="{{ asset('assets/images/shoe-detail/3.jpg') }}" alt=""></div>
              <div class="item"><img src="{{ asset('assets/images/shoe-detail/3.jpg') }}" alt=""></div>
            </div><a class="popup-youtube ps-product__video" href="http://www.youtube.com/watch?v=0O2aH4XLbto"><img src="{{ asset('assets/images/shoe-detail/3.jpg') }}" alt=""><i class="fa fa-play"></i></a>
          </div>
        ...
        <div class="ps-product__info">
          ...
          <div class="ps-product__block ps-product__style">
            ...
            <ul>
              <li><a href="product-detail.html"><img src="{{ asset('assets/images/shoe/sidebar/1.jpg') }}" alt=""></a></li>
              <li><a href="product-detail.html"><img src="{{ asset('assets/images/shoe/sidebar/2.jpg') }}" alt=""></a></li>
              <li><a href="product-detail.html"><img src="{{ asset('assets/images/shoe/sidebar/3.jpg') }}" alt=""></a></li>
              <li><a href="product-detail.html"><img src="{{ asset('assets/images/shoe/sidebar/2.jpg') }}" alt=""></a></li>
            </ul>
          </div>
...
@include('layouts.components.related')
@endsection